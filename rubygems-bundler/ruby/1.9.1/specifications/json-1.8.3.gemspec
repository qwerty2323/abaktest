...
Gem::Specification.new do |s|
  ...
  s.extensions = [%q{ext/json/ext/generator/extconf.rb}, %q{ext/json/ext/parser/extconf.rb}, %q{ext/json/extconf.rb}]
  s.extra_rdoc_files = [%q{README.rdoc}]
  s.files = [%q{README.rdoc}, %q{ext/json/ext/generator/extconf.rb}, %q{ext/json/ext/parser/extconf.rb}, %q{ext/json/extconf.rb}]
