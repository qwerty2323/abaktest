...
and added by the users of MIME::Types.}
  ...
  s.extra_rdoc_files = [%q{Contributing.rdoc}, %q{History.rdoc}, %q{Licence.rdoc}, %q{Manifest.txt}, %q{README.rdoc}, %q{docs/COPYING.txt}, %q{docs/artistic.txt}]
  s.files = [%q{Contributing.rdoc}, %q{History.rdoc}, %q{Licence.rdoc}, %q{Manifest.txt}, %q{README.rdoc}, %q{docs/COPYING.txt}, %q{docs/artistic.txt}]
  s.homepage = %q{http://mime-types.rubyforge.org/}
  s.licenses = [%q{MIT}, %q{Artistic 2.0}, %q{GPL-2}]
